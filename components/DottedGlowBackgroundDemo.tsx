      ...
      <div className="relative z-10 flex w-full flex-col items-center justify-between space-y-6 px-8 py-16 text-center md:flex-row">
        <div>
          <h2 className="text-center text-4xl font-normal tracking-tight text-neutral-900 sm:text-5xl md:text-left dark:text-neutral-400">
            Ready to transform{' '}
            <span className="font-bold dark:text-white">your digital presence</span>?
          </h2>
          <p className="mt-4 max-w-lg text-center text-base text-neutral-600 md:text-left dark:text-neutral-300">
            Unlock premium web design solutions, advanced animations, and exclusive features to build stunning modern interfaces.
          </p>
        </div>
        <div className="flex flex-col gap-4 sm:flex-row">
          ...
          <button className="inline-flex items-center justify-center rounded-lg border border-yellow-500 bg-yellow-500 px-8 py-3 text-sm font-medium text-black shadow-sm transition-all duration-200 hover:bg-yellow-400 hover:shadow-md">
            View Pricing
          </button>
        </div>
      </div>
